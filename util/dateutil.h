...
public:
    ...
    static QDate solarToLunar(int Year, int Month, int Day);
    static QDate solarToLunar(QDate dNow);
    static QString Check_TodaySpecial();
    static QString GetTodaySpecial(int Year, int Month, int Day);
